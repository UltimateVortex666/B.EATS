...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food-picky-logo.png" style="width: 200px; height: auto;" alt=""> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/main.jpg" style="width: auto; height: auto;">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Take - Away - System</h1>
                    <h5 class="font-white space-xs">Find restaurants and order food </h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Search for your favourite....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="Search for your favourite...."> </div>
                            </div>
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span> Take out</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min INR 200.00</div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/food-picky-logo.png" style="width: 200px; height: auto;"alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
